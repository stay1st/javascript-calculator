// export default function TokeNParse(textStr) {
...
//   33*3-3;
//   `
//   console.log('%cTokens:','color: blue;', str)
...
//   console.log('asts afterParser:', asts);
